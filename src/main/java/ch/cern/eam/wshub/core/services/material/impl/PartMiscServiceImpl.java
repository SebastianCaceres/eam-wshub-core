...
public class PartMiscServiceImpl implements PartMiscService {
    ...
    public PartMiscServiceImpl(ApplicationData applicationData, Tools tools, InforWebServicesPT inforWebServicesToolkitClient, PartAssociationRepository partAssociationRepository) {
    ...
    public String createIssueReturnTransaction(InforContext context, IssueReturnPartTransaction issueReturnPartTransaction) throws InforException {
        ...
        switch(issueReturnPartTransaction.getTransactionOn()) {
            case WORKORDER:
                ...
                if (issueReturnPartTransaction.getWorkOrderNumber() != null && issueReturnPartTransaction.getActivityCode() != null) {
                    ...
                    issueReturnTransactionInfor.getACTIVITYID().getACTIVITYCODE().setValue(tools.getDataTypeTools().encodeLong(issueReturnPartTransaction.getActivityCode(), "Activity Code"));
                }
                break;
            case PROJECT:
                // PROJECT - BUDGET
        ...
        for (IssueReturnPartTransactionLine line : issueReturnPartTransaction.getTransactionlines()) {
            ...
            if (isNotEmpty(line.getAssetIDCode()) && "ISSUE".equalsIgnoreCase(issueReturnPartTransaction.getTransactionType()) && IssueReturnPartTransactionType.WORKORDER.equals(issueReturnPartTransaction.getTransactionOn())) {
        ...
        MP0220_AddIssueReturnTransaction_001_Result result = tools.performInforOperation(context, inforws::addIssueReturnTransactionOp, addIssueReturnTransaction);
    ...
    public String createPartSubstitute(InforContext context, PartSubstitute partSubstitute) throws InforException {
        ...
        if (partSubstitute.getPartA() != null) {
            ...
            addPartSub.getSubstitutePart().getSUBSTITUTEPARTID().getPARTAID().setORGANIZATIONID(tools.getOrganization(context));
        ...
        if (partSubstitute.getPartB() != null) {
            ...
            addPartSub.getSubstitutePart().getSUBSTITUTEPARTID().getPARTBID().setORGANIZATIONID(tools.getOrganization(context));
    ...
    public Bin readStoreBin(InforContext context, Bin binParam) throws InforException {
        ...
        MP0282_GetStoreBin_001_Result mp0282_getStoreBin_001_result = tools.performInforOperation(context, inforws::getStoreBinOp, getStoreBin);
    ...
    public String updateStoreBin(InforContext context, Bin binParam) throws InforException {
        ...
        StoreBin result = mp0282_getStoreBin_001_result.getResultData().getStoreBin();
        //Update storeBin
        StoreBin storeBin2 = tools.getInforFieldTools().transformWSHubObject(result, binParam, context);
        MP0283_SyncStoreBin_001 syncStoreBin = new MP0283_SyncStoreBin_001();
        syncStoreBin.setStoreBin(storeBin2);
        MP0283_SyncStoreBin_001_Result syncResult = tools.performInforOperation(context, inforws::syncStoreBinOp, syncStoreBin);
        return null;
    }
    ...
    public String deleteStoreBin(InforContext context, Bin binParam) throws InforException {
        ...
        MP0284_DeleteStoreBin_001_Result deleteStoreBin_001_Result = tools.performInforOperation(context, inforws::deleteStoreBinOp, deleteBinOp);
        return null;
    }
    ...
    public String createBin2binTransfer(InforContext context, Bin2BinTransfer bin2BinTransfer) throws InforException {
        net.datastream.schemas.mp_entities.bin2bintransfer_001.Bin2BinTransfer bin2BinTransferInfor = new net.datastream.schemas.mp_entities.bin2bintransfer_001.Bin2BinTransfer();
        ...
        if (transactionLine != null) {
            ...
            bin2BinTransferInfor.setSTOCKQTY(DataTypeTools.encodeQuantity(transactionLine.getTransactionQty(), "Stock Quantity"));
